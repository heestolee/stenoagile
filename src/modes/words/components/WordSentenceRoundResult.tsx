  ...
  return (
    <div className="p-4 border-2 border-green-500 rounded bg-green-50">
      ...
      <div className="flex gap-4 text-sm">
        ...
        {roundCompleteResult.avgKpm > 0 && <span className="text-gray-600">평균 타수 {roundCompleteResult.avgKpm} / 자수 {roundCompleteResult.avgCpm}</span>}
      </div>

      {mode === "sentences" && hasSentences && !isSentenceReview && (
        <button className="mt-2 px-4 py-1.5 rounded font-semibold bg-purple-500 text-white hover:bg-purple-600 transition text-sm" onClick={() => {
